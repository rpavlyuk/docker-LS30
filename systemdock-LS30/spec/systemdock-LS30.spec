%define         _module systemdock-LS30
...
Summary:	SystemDock profile to run LS-30 container as systemd service
...
%description
SystemDock profile to run LS-30 container as systemd service
...
ln -s %{_sysconfdir}/systemdock/containers.d/LS-30/%{_module}.service $RPM_BUILD_ROOT%{_unitdir}/%{_module}.service

%files
%doc README.md

%config(noreplace) %{_sysconfdir}/systemdock/containers.d/LS-30/config.yml
%{_sysconfdir}/systemdock/containers.d/LS-30/%{_module}.service
